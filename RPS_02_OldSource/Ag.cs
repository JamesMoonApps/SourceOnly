...
public class Ag  {
    ...
    public static bool mIsAppfriend;
    ...
    //  ////////////////////////////////////////////////     State Array / CurWorldState
	public static StateArray mgWorldStateArray;
    //public static BaseState mCurWorldState;
    ...
    public static List<AmPlayer> arrPlayerAvailable; // = new List<int>();
    public static List<Rank> arrUserRank; // = new List<int>();
	...
	public static AmServer mVirServer; // [2012:11:11:MOON] Single Mode...
    ...
    public static void Init() {
        ...
        mSingleMode = Ag.mgFBisValid = false; // [2012:11:11:MOON] Single Mode...
		...
		mgWorldStateArray = new StateArray();
        
        Ag.net = new AmNetwork();  //  Multi Threading Started....
        ...
        if ( Ag.mgLanguage != "Chi" && Ag.mgLanguage != "Kor" && Ag.mgLanguage != "Jap" && 
            ...
            Ag.mgLanguage = "Eng";
        //*/
        Ag.LogString("Current Language is >>> " + Ag.mgLanguage);
...
#endif
        if ( mgScrX < mgScrY ) {  mgScrY = mgScrX;  mgScrX = Screen.height; } 
    ...
    public static void LogIntenseWord ( string pWord ) {
        Debug.Log("\n"); Debug.Log("\n"); Debug.Log("\n"); 
        Debug.Log ( SIGN_INTENSE ); Debug.Log ( SIGN_INTENSE );
